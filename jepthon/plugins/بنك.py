...
- مثال: .انشاء حساب الرافدين او سيرثون الاسلامي
1- .استثمار (مبلغ) 
- مثال : استثمار 18276
2- .حظ (المبلغ)
- مثال : حظ 17267
...
async def bankar(message):
    ...
    if input == "سيرثون الاسلامي":
        bankn = "مصرف سيرثون الاسلامي"
    elif input == "الرافدين":
    	bankn = "مصرف الرافدين"
    elif input != "الرافدين" or "سيرثون الاسلامي":
